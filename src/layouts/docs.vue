<template>
  <div class="min-h-screen bg-gray-950">
    ...
    <div class="flex pt-16">
      <!-- 左侧导航栏 -->
      <aside class="fixed left-0 top-16 bottom-0 w-64 bg-gray-900/50 border-r border-gray-800 overflow-y-auto z-40 transition-transform duration-300 -translate-x-full lg:translate-x-0" :class="{ 'translate-x-0': sidebarOpen }">
        <div class="p-6">
          ...
          <nav class="space-y-2">
            ...
            <div class="mb-4">
              <NuxtLink 
                ...
                :class="{ 'text-primary-400 bg-gray-800/50': $route.path === '/docs' }"
              >
            ...
            <div>
              ...
              <div class="ml-4 space-y-1">
                <NuxtLink 
                  ...
                  :to="client.path"
                  class="flex items-center space-x-3 px-3 py-2 rounded-lg text-gray-300 hover:text-primary-400 hover:bg-gray-800/50 transition-all duration-200"
                  :class="{ 'text-primary-400 bg-gray-800/50': $route.path === client.path }"
                >
